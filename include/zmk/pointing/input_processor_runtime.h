 ...
 * @param scale_multiplier Pointer to store the scaling multiplier (can be NULL)
 * @param scale_divisor Pointer to store the scaling divisor (can be NULL)
 * @param rotation_degrees Pointer to store the rotation angle (can be NULL)
 * @return 0 on success, negative error code on failure
 */
